...
// async function connectToDatabase() {
    ...
    // const client = new MongoClient(uri, {
        // tls: true,
        // tlsAllowInvalidCertificates: true // Vercel/Atlas SSL handshake issues ko bypass karne ke liye
    // });
...
async function connectToDatabase() {
    if (cachedClient) return cachedClient;
    // Yahan options hata kar sirf uri pass karein taake koi conflict na ho
    const client = new MongoClient(uri);
    await client.connect();
    cachedClient = client;
    return client;
